...
def recalculate_part(part_id: int, db: Session) -> None:
    ...
    delivery_per_piece = (part.material_delivery_cost or 0.0) / n_parts
    part.total_cost = round((part.material_cost or 0.0) + delivery_per_piece + phase_total_per_piece, 4)
